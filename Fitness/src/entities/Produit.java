...
private static int id_courant;
    ...
    public String toString() {
        return "nom_produit=" + nom_produit + ", prix_produit=" + prix_produit + ", quantite_produit=" + quantite_produit + ", ID_categorie=" + ID_categorie + ", image_produit=" + image_produit + ", description=" + description + ", etat=" + etat ;
    }
